...
<Navbar />
      ...
      <section className="min-h-screen flex flex-col items-center justify-center px-4 relative overflow-hidden">
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[70vw] h-[70vw] bg-white/[0.03] rounded-full blur-[120px] pointer-events-none"></div>

        <div className="z-10 w-full max-w-4xl mx-auto text-center mt-12 mb-8 animate-slide-up">

          <h1 className="font-heading text-6xl md:text-8xl lg:text-9xl mb-6 tracking-wider uppercase leading-none">
            Instagram Reels
            <br />
        ...
        <div className="text-center mt-16 opacity-60">
          ...
          <div className="flex justify-center gap-10 text-gray-400 font-medium">
            <span>Instagram</span>
            <span>Twitter / X</span>
            <span>Facebook</span>
          </div>
...
const FeatureCard = ({ icon, title, desc }) => (
  <div className="bg-[#111111] p-8 rounded-2xl border border-white/5 hover:border-white/20 transition-colors">
